...
using Smm.ContohCQRSNoEventSourcing.ServiceApplication.Agama.Queries.AgamaList;
using Smm.ContohCQRSNoEventSourcing.ServiceApplication.DataKonsumen.Commands.CreateDataKonsumen;
using Smm.ContohCQRSNoEventSourcing.ServiceApplication.DataKonsumen.Mapping;
using Smm.ContohCQRSNoEventSourcing.ServiceApplication.DataKonsumen.Queries.ListDataKonsumen;
using Smm.ContohCQRSNoEventSourcing.ServiceApplication.JenisKelamin.Queries.JenisKelaminList;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace Smm.ContohCQRSNoEventSourcing.Controllers
{
