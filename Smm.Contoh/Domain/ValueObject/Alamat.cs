...
namespace Smm.Contoh.Domain.ValueObject
{
    public class Alamat : ValueObject<Alamat>
    {
        ...
        public Alamat(string jalan, string kelurahan, string kecamatan, string kota, string propinsi, string kodePos, string noTelepon, string noFax, string noHandphone)
        {
            Jalan = jalan;
            Kelurahan = kelurahan;
            Kecamatan = kecamatan;
