...
namespace Smm.ContohMVC.Data.Migrations
{
    ...
    [Migration("20210806072443_test2")]
    partial class test2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smm.Contoh2.Domain.DataKonsumen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Smm.ContohMVC.Domain.EnumInEntity.Agama", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Smm.ContohMVC.Domain.EnumInEntity.JenisKelamin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Smm.Contoh2.Domain.DataKonsumen", b =>
                {
                    b.OwnsOne("Smm.Contoh2.Domain.ValueObject.Alamat", "AlamatKirim", b1 =>
                        {
                    ...
                    b.OwnsOne("Smm.Contoh2.Domain.ValueObject.Alamat", "AlamatTinggal", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.Contoh2.Domain.ValueObject.Name", "Nama", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.Contoh2.Domain.ValueObject.Name", "NamaBPKB", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.Contoh2.Domain.ValueObject.NomorKTP", "NoKTP", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
