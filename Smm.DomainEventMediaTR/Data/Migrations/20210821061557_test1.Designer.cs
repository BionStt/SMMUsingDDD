...
namespace Smm.DomainEventMediaTR.Data.Migrations
{
    ...
    [Migration("20210821061557_test1")]
    partial class test1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smm.DomainEventMediaTR.Domain.DataKonsumen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Smm.DomainEventMediaTR.Domain.EnumInEntity.Agama", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Smm.DomainEventMediaTR.Domain.EnumInEntity.JenisKelamin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Smm.DomainEventMediaTR.Domain.DataKonsumen", b =>
                {
                    b.OwnsOne("Smm.DomainEventMediaTR.Domain.ValueObject.Alamat", "AlamatKirim", b1 =>
                        {
                    ...
                    b.OwnsOne("Smm.DomainEventMediaTR.Domain.ValueObject.Alamat", "AlamatTinggal", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.DomainEventMediaTR.Domain.ValueObject.Name", "Nama", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.DomainEventMediaTR.Domain.ValueObject.Name", "NamaBPKB", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Smm.DomainEventMediaTR.Domain.ValueObject.NomorKTP", "NoKTP", b1 =>
                        {
                            b1.Property<Guid>("DataKonsumenId")
                                .HasColumnType("uniqueidentifier");
